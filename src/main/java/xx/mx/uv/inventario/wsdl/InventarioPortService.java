 ...
 * 
 */
@WebServiceClient(name = "inventarioPortService", targetNamespace = "t4is.uv.mx/inventario", wsdlLocation = "https://inventariows-production.up.railway.app/ws/inventario.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://inventariows-production.up.railway.app/ws/inventario.wsdl");
